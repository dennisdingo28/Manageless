    ...
    <div className="mt-3">
        <div className="container mx-auto">
            ...
            <div className="flex flex-col gap-5 mt-4 md:flex-row ">                
                ...
                <TextBox title="Getting Started" links={[{text:"Sign In",url:"/signIn",handleClick() {
                  signIn("google");
                },  }]} text="Making the process quicker is one of the strongest point of Manageless. It's never been easier, with just a few clicks, set up an account, if you do not already have one and boost your productivity."/>
            </div>
        </div> 
    </div>
  )
